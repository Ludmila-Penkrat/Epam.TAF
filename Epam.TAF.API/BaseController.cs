    ...
    public class BaseController
    {
        ...
        protected (RestResponse Response, T ResponseModel) Get<T>(string resource)
        {
            ...
            return (typeof(T) == typeof(RestResponse))
                ? (response, default)
                : (response, GetDesereliazedView<T>(response));
        }
        ...
        protected (RestResponse Response, T ResponseModel) Patch<T, TPayload>(string resource, TPayload payload = null) where TPayload : class
        {
        ...
        private T GetDesereliazedView<T>(RestResponse response)
        {
