...
namespace Epam.TAF.BDD.Steps.Pages
{
    ...
    public class HeaderLinksPagesSteps
    {
        ...
        [Then(@"I check that '(Services|Insights|About|Careers)' link page is opened")]
        public void ThenICheckThatLinkPageIsOpened(HeaderLinkEnums headerLink)
        {
            ...
            switch (headerLink)
            {
                ...
                case HeaderLinkEnums.Insights:
                    expectedResult = InsightsPage.InsightsPageBreadCrumsIsDisplayed();
